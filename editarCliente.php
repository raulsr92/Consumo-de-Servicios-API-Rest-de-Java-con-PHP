      ...
      <div class="container d-flex justify-content-center align-items-center vh-120">
        <div class="card p-4 shadow-lg" style="width: 100%; max-width: 850px;">
          ...
          <?php
          	...
          	$id = $_GET["id"]; //de esta forma traemos la variable ID de gestionClientes.php 
                               // cuando damos click en el icono de ELIMINAR

            $url = "http://localhost:8080/ep4DaeII/cliente/".$id; //usamos servicio de busqueda de cliente x ID
            $datos = file_get_contents($url);
            $datos1 = json_decode($datos,true);

            $codigo = $datos1['codigo'];
            $nombre = $datos1['nombre'];
            $paterno =  $datos1['apellidoPaterno'];
            $materno =  $datos1['apellidoMaterno'];
            $dni2 =  $datos1['dni'];
          ...
          <form action="actualizarCliente.php" method="POST">
            <div class="mb-3">
              ...
              <?php // Imprimier el código del cliente seleccionado para editar
                echo "<input type='text' class='form-control' id='nombre' name='codigo' value='$codigo' readonly required>"
              ?>
            ...
            <div class="mb-3">
              ...
              <?php // Imprimier el nombre del cliente seleccionado para editar
            ...
            <div class="mb-3">
              ...
              <?php // Imprimir el apellido paterno del cliente seleccionado para editar
                echo "<input type='text' class='form-control' id='apellidoPaterno' name='apePa'  value='$paterno'  required>"
              ?>
            </div>
            <div class="mb-3">
              <label for="apellidoMaterno" class="form-label">Apellido Materno</label>
              <?php // Imprimir el apellido materno del cliente seleccionado para editar
                echo "<input type='text' class='form-control' id='apellidoMaterno' name='apeMa'  value='$materno'  required>"
              ?>
            </div>
            <div class="mb-3">
              <label for="dni" class="form-label">DNI</label>

              <?php // Imprimir el DNI del cliente seleccionado para editar
                echo "<input type='text' class='form-control' id='dni' name='dni'  value='$dni2'  required>"
              ?>
            </div>
            <!-- Re -> Retail Express -->
